...
<div id="wrapper">
    ...
    <form id="myform"> <!--using id links to JS function -->
        ...
        <input type="submit" value="Login" id="login_button"><br>  <!--using the id links with js function"-->
...
<script type="text/javascript">
    ...
    /*Function one aimed to getElementById("Login_button")*/
    function _(element) {
    ...
    login_button.addEventListener("click", collect_data); /*addEventListener("click", run collect_data function)*/


    function collect_data(e) {
        e.preventDefault();  //for submit button to have an addEventListner to enter press.
        ...
        send_data(data, "login"); /*data, data_type*/
